...
. Tipos de archivo: suprime las alertas de manipulación de archivos en tipos de archivo específicos <<file-types,Tipos de archivo permitidos>>
...
* Lista de exclusión de directorios: Admite hasta cuatro niveles de rutas de directorio, empezando por la ruta de unión. Todos los subdirectorios y archivos que se encuentren bajo esta ruta se excluirán para la generación de alertas. No se admiten comodines en las rutas de directorio.


image:ws_alert_exclusions_users.png["Usuarios excluidos de alertas"]

image:ws_alert_exclusions_paths.png["Rutas de exclusión de alertas"]
