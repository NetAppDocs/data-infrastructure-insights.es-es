...
Página detallada de un posible ataque de ransomware: vista "Screen": los widgets de tabla muestran el objeto/agrupación a la izquierda y los datos del objeto (atributos/métricas) a la derecha.
...
'''
Widget de valor con formato] image:Single-Value Widgets - Formatted.png["Widgets de valor único con formato"]
