...
=== ¡El asistente de IA de DII está disponible para todos!

El Asistente de IA de Data Infrastructure Insights está disponible para Preview y ahora incluye las siguientes mejoras:

* Disponibilidad de la región Azure: para los clientes cuyo sitio de DII está alojado en Azure, el DII Assistant ya está listo para ayudarte.
* Hasta 7 días de datos: el Assistant ahora puede acceder a hasta 7 días de métricas de alta resolución, lo que permite un análisis de datos y perspectivas de mayor alcance.
