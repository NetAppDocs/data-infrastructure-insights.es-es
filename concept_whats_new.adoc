...
=== Visualizaciones del asistente de IA

Convierte datos complejos en información gráfica al instante. Pídele al asistente de IA que cree un panel de control y visualizará la respuesta con gráficos y tablas interactivos, ayudándote a identificar tendencias y resolver problemas más rápido sin tener que crear gráficos manualmente.

image:ai_assistant-column_graph.png["Visualización del asistente de IA"]



[[enhanced-vm-analyzer-filtering]]
=== Filtrado mejorado de VM Analyzer

Un nuevo botón de la vista «VM Analyzer» te permite ocultar los volúmenes montados que no tienen un datastore, lo que ofrece una vista más clara para simplificar la resolución de problemas en las VMs.

image:vm_analyzer_datastore_only_view.png["Control deslizante de vista solo almacén de datos"]



[[ui-update-user-data-edit-mode]]
=== Actualización de la interfaz de usuario: modo de edición de datos de usuario

Mantén la información de los activos precisa y reduce al mismo tiempo el riesgo de cambios involuntarios. Las anotaciones y los atributos (es decir, “User Data”) ahora aparecen en modo de solo lectura por defecto, así puedes revisar primero los detalles y elegir cuándo quieres editarlos.

Edita solo cuando lo necesites. Desde un panel deslizante, expande los detalles del recurso y selecciona el icono del lápiz. La página principal del recurso se abre en modo de edición, donde puedes actualizar la información y seleccionar Guardar cuando termines.

También puedes abrir directamente la página de inicio del activo y seleccionar Editar en la esquina superior derecha.

image:UserDataEdit-Slideout.png["Editar datos de usuario en el panel deslizable-icono del lápiz, ancho=400"]

image:UserDataEdit-LP.png["Modo de edición de la página de destino, ancho=200"]
...
=== Página de inicio del nuevo asistente de IA

El asistente de IA de DII cuenta ahora con una página de inicio específica, que pone el análisis inteligente de la infraestructura en primer plano. Inicia nuevas conversaciones al instante, retoma tu última sesión con un solo clic o empieza rápidamente con las sugerencias que te ofrece.

image:AI_dashboard_page_default.png["Panel de control de IA predeterminado, ancho=800"]

Accede a la página de inicio desde *AI Assistant* en el menú de navegación o abre AI Assistant desde cualquier lugar usando el icono de las "estrellas" en la esquina superior izquierda.

image:AI_dashboard_page_menu.png["Menú de navegación del asistente de IA, ancho=600"] image:AI_assistant_access_button.png["Acceso al asistente de IA desde cualquier lugar, width=300"]
...
=== Comparte actualizaciones importantes mediante mensajes de inicio de sesión

Mantén a tu equipo informado y alineado con mensajes de inicio de sesión personalizables. Comunica anuncios importantes, horarios de mantenimiento o actualizaciones de políticas directamente a los usuarios cuando inicien sesión. Con soporte para markdown, puedes dar formato a los mensajes para mayor claridad y asegurarte de que la información crítica llegue a cada usuario de DII. Las cuentas con privilegios de admin pueden encontrar la configuración en el menú Admin, en Notificaciones.



[[more-workspace-less-clutter]]
=== Más espacio de trabajo, menos desorden

El menú de navegación de DII presenta un nuevo y renovado diseño, que ahora se adapta a los colores y al comportamiento de Console para ofrecer una experiencia más unificada. El menú principal, que antes era estático, aparecerá oculto de forma predeterminada para proporcionar un espacio de trabajo más centrado y un uso más eficiente del espacio en pantalla. Simplemente haz clic en el icono de hamburguesa (☰) en la esquina superior izquierda para acceder a él.



[[expand-device-visibility-with-intelligent-ai-assistance]]
=== Amplía la visibilidad de los dispositivos con la asistencia inteligente de IA

Acelera la incorporación de nuevos dispositivos gracias a la identificación de dispositivos basada en IA. Data Infrastructure Insights analiza tu entorno y sugiere reglas de resolución automática de dispositivos, lo que te ayuda a identificar y gestionar rápidamente un mayor número de dispositivos. Solo tienes que revisar y aprobar las reglas generadas por la IA y DII se encarga del resto, mejorando la visibilidad y la gestión de los dispositivos en toda tu infraestructura.



[[a-smarter-ai-assistant-for-global-teams]]
=== Un asistente de inteligencia artificial más inteligente para equipos globales

El Asistente de Inteligencia Artificial ahora es compatible con más de una docena de idiomas, lo que permite a tu equipo interactuar de forma natural en su idioma preferido. Consulta la lista completa link:https://platform.claude.com/docs/en/build-with-claude/multilingual-support["aquí"^].



[[new-monitors-for-infrastructure-attribute-changes]]
=== Nuevos monitores para cambios de atributos de la infraestructura

Los monitores de atributos ahora están disponibles para alertar automáticamente a tu equipo cuando los activos se mueven entre centros de datos, un grupo de almacenamiento no está cifrado o se produce cualquier modificación de atributos. Esto ayuda a mantener las líneas de base de configuración y ayuda a garantizar que nada se escape durante los nuevos despliegues o cambios.

image:attribute_monitor_in_list.png["los monitores de atributos se añaden a los tipos de monitor"]



[[build-smarter-alerts-and-webhooks-with-dynamic-context-rich-messages]]
=== Crea alertas y webhooks más inteligentes con mensajes dinámicos y ricos en contexto

Cuando crees un monitor o un webhook, simplemente escribe "%" en la descripción de la alerta o en la URL, el encabezado o el cuerpo del webhook para elegir de una lista dinámica de atributos y anotaciones de objetos disponibles. Dale a tus alertas el contexto adecuado para mejorar la claridad, potenciar la integración del webhook y acelerar los tiempos de respuesta.

image:attribute_list_example.png["lista de atributos en la descripción de un monitor, width=400"]
...
=== DII conoce tu entorno mejor que nunca

Hemos mejorado la forma en que la IA de Data Infrastructure Insights comprende tu configuración. Aprovecha un contexto más rico sobre tu uso actual del servicio, la configuración y los patrones de rendimiento antes de responder. El resultado es una orientación inicial que refleja tu entorno en lugar de un punto de partida genérico, con menos seguimientos necesarios para llegar a una respuesta útil.

Por ejemplo, navega hasta un dispositivo de almacenamiento y el Asistente de IA te da respuestas con un solo clic a preguntas como:

* ¿Cómo está evolucionando el uso de la capacidad de este almacenamiento y qué StoragePools están consumiendo más espacio?
* ¿Puedes mostrarme la tendencia de uso de la capacidad de este dispositivo en las últimas 24 horas?
* ¿Qué volúmenes están consumiendo más espacio en este almacenamiento?
...
=== AI Assistant ya está disponible de forma general

El asistente de IA de Data Infrastructure Insights ya está disponible de forma general para todos los clientes de sitios de DII alojados en AWS.

Ten en cuenta que el AI Assistant en sitios Azure aún está en versión preliminar. Estate atento a este espacio para el anuncio de la disponibilidad general.



[[infrastructure-insights-features-removed]]
=== Funciones eliminadas de Infrastructure Insights

Las funciones "Infrastructure Insights" de DII, _Shared Resources Under Stress_, _Kubernetes Namespaces Running out of Space_ y _Reclaiming ONTAP Cold Storage_ ya no están disponibles en DII.
...
=== Respuestas inteligentes instantáneas sobre tu infraestructura

Conoce al nuevo socio inteligente de tu infraestructura: el link:ai_for_dii_overview.html["*Asistente de IA de Data Infrastructure Insights*"] transforma cómo interactúas con tus datos, convirtiendo consultas complejas en conversaciones sencillas. Descubre al instante patrones ocultos, acelera la resolución de problemas y toma decisiones condicionadas por los datos con confianza. Obtén respuestas instantáneas a preguntas como:
...
La vista previa del asistente de IA de DII está disponible ahora para la mayoría de los clientes con servicio alojado en regiones de AWS; la región de Azure estará disponible pronto. link:concept_preview_features.html["Más información"] sobre las funciones de la Vista Previa de Data Infrastructure Insights.

image:ai_assistant_icon.png["Icono de AI Assistant"]
...
==== Personaliza los monitores del sistema más rápido, sin duplicar

Modifica directamente los monitores predeterminados del sistema para adaptarlos a tus necesidades: cambia nombres, filtros y agrupación en un solo lugar. No necesitas crear monitores duplicados para ajustes sencillos. Un banner útil te recuerda qué monitores han sido personalizados, manteniendo total visibilidad de tu configuración de monitorización.



==== Simplifica la gestión de monitores con acciones masivas

Administra varios monitores a la vez mediante Bulk Actions. Ajusta rápidamente la configuración de Health Monitoring para grupos de monitores, ahorrando tiempo y reduciendo la complejidad. Actualiza tu estrategia de monitorización en todos los monitores en segundos, no en minutos.



==== Enfoca las puntuaciones de salud de tu infraestructura en lo que más importa

Excluye objetos específicos de tus puntuaciones de estado de la infraestructura para mantener la precisión y la relevancia. Cuando veas tu panel de estado de la infraestructura, elimina al instante los objetos a los que quieras quitar prioridad sin modificar la configuración del monitor. Esto centra tus alertas en los elementos de la infraestructura que impulsan tus prioridades empresariales.

image:health_monitoring_exclude_object.png["excluir objeto de la supervisión del estado"]
...
Los siguientes sistemas operativos Linux son compatibles actualmente con Data Infrastructure Insights link:concept_acquisition_unit_requirements.html["Unidades de adquisición"]:
...
* Rocky 9.2 a 9.6
* SUSE Linux Enterprise Server 15 SP4 hasta 15 SP7, 16
...
La solución Reclaim ONTAP Cold Storage Insight ahora es compatible con FlexGroups y ya está disponible para todos los clientes.
...
| Los espacios de nombres de Kubernetes se están quedando sin espacio | La vista «Kubernetes Namespaces Running Out of Space» te ofrece información sobre las cargas de trabajo de tus espacios de nombres de Kubernetes que corren el riesgo de quedarse sin espacio, junto con una estimación del número de días restantes antes de que cada espacio se llene por completo. 


| Recurso compartido bajo estrés | La función _Shared Resource Under Stress_ utiliza IA y aprendizaje automático para identificar automáticamente en qué puntos la competencia por los recursos está provocando una disminución del rendimiento en tu entorno, destaca las cargas de trabajo afectadas por ello y ofrece recomendaciones para solucionarlo, lo que te permite resolver los problemas de rendimiento con mayor rapidez. 
...
Cloud Insights destaca periódicamente una serie de nuevas y emocionantes funciones en fase de prueba. Si te interesa probar una o varias de estas funciones, ponte en contacto con tu equipo de ventas de NetApp para más información.
...
| Recurso compartido bajo estrés | La función «Shared Resource Under Stress» utiliza IA y aprendizaje automático para identificar automáticamente en qué puntos la competencia por los recursos está provocando una disminución del rendimiento en tu entorno, destaca las cargas de trabajo afectadas por ello y ofrece recomendaciones para solucionarlo, lo que te permite resolver los problemas de rendimiento con mayor rapidez. 
|===
...
'''nt1.png[Gestión de unidades del widget de tabla]
