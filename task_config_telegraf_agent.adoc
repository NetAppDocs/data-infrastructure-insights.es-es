...
TIP: Una vez que hayas instalado un agente en un servidor o máquina virtual, Data Infrastructure Insights recopila métricas de ese sistema además de recopilar de cualquier recopilador de datos que configures. Estas métricas se recopilan como métricas de "Node".
