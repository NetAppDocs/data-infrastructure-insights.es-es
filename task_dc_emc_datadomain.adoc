...
[role="lead"]
Este recopilador de datos reúne información de inventario de los sistemas de almacenamiento con deduplicación DELL EMC Data Domain. Para configurar este recopilador de datos, existen instrucciones de configuración y recomendaciones de uso específicas que debes seguir.
