...
summary: Los agentes de seguridad de carga de trabajo supervisan la actividad del usuario y detectan amenazas de seguridad en su entorno de almacenamiento. 
---
...
[role="lead"]
Los agentes de seguridad de carga de trabajo son esenciales para supervisar la actividad del usuario y detectar posibles amenazas de seguridad en toda su infraestructura de almacenamiento. Esta guía proporciona instrucciones paso a paso para implementar agentes en su entorno. Antes de comenzar, asegúrese de que su servidor agente cumpla con los requisitos. link:concept_cs_agent_requirements.html["Requisitos del sistema"].
