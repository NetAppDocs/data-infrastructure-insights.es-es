...
NOTE: La recopilación de rendimiento de Data Infrastructure Insights de los clústeres VPLEX requiere que el servicio de archivo de rendimiento esté operativo para poder llenar los archivos .CSV y los registros que Data Infrastructure Insights recupera mediante copias de archivos basadas en SCP. NetApp ha observado que muchas actualizaciones de firmware/estación de gestión de VPLEX dejan esta funcionalidad fuera de servicio. Los clientes que planean este tipo de actualizaciones pueden querer preguntar proactivamente a Dell/EMC si la actualización que tienen planeada dejará esta funcionalidad inoperativa y, si es así, cómo pueden volver a habilitarla para minimizar los huecos en la visibilidad del rendimiento. El código de rendimiento VPLEX de Cloud Insights evaluará en cada sondeo si existen todos los archivos esperados y si se están actualizando correctamente; si faltan o están desactualizados, Data Infrastructure Insights registrará fallos en la recopilación de rendimiento.
