...
summary: Crea paneles personalizados con widgets flexibles para visualizar datos de infraestructura, supervisar tendencias de rendimiento y crear vistas operativas adaptadas a tus necesidades específicas de supervisión. 
...
[role="lead"]
Crea paneles personalizados que te proporcionen la información operativa que más necesitas. Elige entre varios tipos de widgets, incluidos tablas, gráficos, indicadores y representaciones, para visualizar los datos de tu infraestructura exactamente como quieras, lo que te permitirá tomar mejores decisiones y realizar una supervisión más eficaz.
