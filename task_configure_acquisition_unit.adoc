...
Si observas que tu AU se bloquea al intentar conectarse a DII, prueba a añadir estos endpoints a tu proxy:
...
Los endpoints de proxy específicos de NetApp Console que puedes necesitar se enumeran en la documentación de link:https://docs.netapp.com/us-en/console-setup-admin/reference-networking-saas-console-previous.html#update-endpoint-list["Administrador de configuración de NetApp Console"].
