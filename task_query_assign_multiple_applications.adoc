...
summary: Gestiona de forma eficiente las aplicaciones y las anotaciones en múltiples activos mediante operaciones masivas basadas en consultas para asignarlas o eliminarlas sin necesidad de configurar manualmente cada activo por separado. 
...
[role="lead"]
Optimiza la gestión de activos utilizando consultas para realizar operaciones masivas sobre aplicaciones y anotaciones. En lugar de configurar manualmente cada activo por separado, puedes asignar o eliminar de forma eficiente varias aplicaciones y anotaciones en grupos de activos con una sola operación.
