...
summary: Asegúrese de que su entorno de implementación de Workload Security Agent cumpla con los requisitos mínimos de sistema operativo, CPU, memoria y espacio en disco para lograr un rendimiento y una recopilación de datos óptimos. 
