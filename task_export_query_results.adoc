...
summary: Exporta los resultados de las consultas, las tablas de los paneles de control, la página de destino y otros datos a archivos .CSV para análisis externo, elaboración de informes e integración con otras aplicaciones mediante procesamiento asíncrono. 
...
[role="lead"]
Exporta datos a archivos .CSV desde consultas, widgets de tablas de paneles de control y tablas de páginas de destino para su análisis externo, la elaboración de informes y la integración con otras aplicaciones. El proceso de exportación asíncrono te permite seguir trabajando mientras se procesan grandes conjuntos de datos en segundo plano.
