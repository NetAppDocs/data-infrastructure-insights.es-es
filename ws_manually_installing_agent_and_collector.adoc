...
.. Nota: el instalador del agente debe descargarse en una carpeta distinta de la que contiene el agente en ejecución.
...
+
Por ejemplo, si el agente se está ejecutando en “/test_user/apps”, el comando sería:
