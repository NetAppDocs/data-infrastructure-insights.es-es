...
summary: Tutorial paso a paso para crear un panel de control del rendimiento de una máquina virtual con tablas, gráficos y widgets que comparan las métricas de la máquina virtual y del almacenamiento. 
...
[role="lead"]
Aprende a crear un panel de control completo sobre el rendimiento de las máquinas virtuales con este tutorial paso a paso. Vas a crear widgets que visualizan los datos de rendimiento de las máquinas virtuales, comparar las métricas de almacenamiento del backend con el rendimiento de las máquinas virtuales del frontend y analizar las relaciones entre la latencia de las máquinas virtuales y la demanda de E/S para obtener mejores ideas operativas.
