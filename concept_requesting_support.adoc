...
[role="lead"]
Data Infrastructure Insights ofrece opciones de soporte completas, incluyendo recursos de autoservicio, foros de la comunidad, documentación y soporte técnico. Accede a estos recursos de soporte seleccionando *Help > Support*, y plantéate activar tu derecho de soporte para desbloquear asistencia técnica completa mediante tickets web y soporte telefónico.
...
Es muy recomendable que marques la casilla para permitir que un ingeniero de soporte de NetApp acceda a tu sitio de Data Infrastructure Insights durante tu sesión de soporte. Esto permitirá al ingeniero solucionar el problema y ayudarte a resolverlo rápidamente. Mientras el ingeniero de soporte tenga acceso a tu sitio, podrá realizar todas las funciones de nivel de administrador.

Cuando tu problema se resuelva o tu sesión de soporte haya terminado, puedes desmarcar la casilla.

Puedes solicitar soporte accediendo a link:https://www.netapp.com/support-and-training/["Sitio de soporte de NetApp"]. Debes tener una suscripción activa a Data Infrastructure Insights.
