...
[role="lead"]
El análisis de cambios de la infraestructura le ofrece una visión integral de los cambios recientes en la infraestructura (almacenamiento, switch, etc.) de su entorno. Con el análisis de cambios, puede realizar un seguimiento de los cambios de configuración y profundizar en los problemas esperados e inesperados.
