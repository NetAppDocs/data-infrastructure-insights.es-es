...
| Titular de la cuenta | Igual que el administrador | Igual que el administrador | Igual que el administrador | Igual que el Administrador, además de administrar la autenticación SSO y la configuración de la federación de identidad. También puede asignar propietarios adicionales, así como agregar clientes al inquilino principal del proveedor de servicios administrados (MSP). 
