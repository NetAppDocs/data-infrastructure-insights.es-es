...
summary: Utilice el Comprobador de tasa de eventos de SVM para medir las tasas de eventos de NFS/SMB y determinar el tamaño óptimo del agente antes de implementar los recopiladores de datos de seguridad de carga de trabajo. 
