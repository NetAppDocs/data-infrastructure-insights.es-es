...
summary: Descubre las mejores prácticas para encontrar las métricas adecuadas, filtrar los activos de forma eficaz y configurar los widgets para crear paneles de control potentes y reveladores. 
...
[role="lead"]
Domina la creación de paneles de control con estrategias contrastadas para encontrar las métricas adecuadas, filtrar activos de forma eficaz y configurar widgets para obtener la máxima información. Estas prácticas recomendadas te ayudan a crear paneles de control más eficaces que ofrecen información útil sobre la infraestructura.
