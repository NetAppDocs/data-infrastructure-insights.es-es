...
summary: Crea consultas personalizadas para buscar, filtrar y analizar los activos y las métricas de tu infraestructura con un control detallado, agrupaciones flexibles y una visualización de resultados personalizable. 
...
[role="lead"]
Crea potentes consultas para buscar activos de tu infraestructura a un nivel de granularidad con funciones flexibles de filtrado, agrupación y ordenación. Crea búsquedas específicas que te ayuden a identificar activos concretos, analizar métricas de rendimiento y organizar los resultados exactamente como los necesites.
