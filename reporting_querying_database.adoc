...
summary: Accede directamente a la base de datos de informes a través de las API, sin pasar por Cognos, para realizar integraciones personalizadas, generar informes automatizados y llevar a cabo flujos de trabajo avanzados de análisis de datos. 
...
[role="lead"]
Accede a la base de datos de informes de Data Infrastructure Insights directamente a través de API compatibles con OData v4, sin pasar por la interfaz de Cognos, lo que te da mayor flexibilidad. Esto permite integraciones personalizadas, flujos de trabajo automatizados de generación de informes y análisis avanzados de datos para los usuarios que necesitan acceso programático a los datos de su infraestructura.
...
La API de informes de Data Infrastructure Insights sigue el estándar link:https://www.odata.org/["OData versión 4"] (Open Data Protocol) para sus consultas en la base de datos de informes. Para obtener más información, consulta link:https://www.odata.org/getting-started/basic-tutorial/["este tutorial"] sobre OData.
