...
summary: Accede a información detallada sobre la gestión centralizada del almacenamiento gracias a informes exhaustivos sobre el uso de la capacidad, las tendencias de rendimiento y la previsión de recursos para una gestión proactiva del centro de datos. 
...
[role="lead"]
El panel de control de Storage Manager te ofrece información centralizada sobre tu entorno de almacenamiento a través de informes y visualizaciones exhaustivos. Supervisa el uso de la capacidad, haz un seguimiento de las tendencias de rendimiento a lo largo del tiempo y compara las métricas actuales con los rangos aceptables para que puedas tomar decisiones informadas sobre el mantenimiento del centro de datos y la planificación de recursos.
