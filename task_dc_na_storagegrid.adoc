...
* Puerto 443 (o 8443 si está configurado)
...
| Dirección IP del host de StorageGRID | Dirección IP de gestión de StorageGRID (Grid Manager) 


| Nombre de usuario | Nombre usado para iniciar sesión en StorageGRID (Grid Manager) 


| Password | Contraseña utilizada para iniciar sesión en StorageGRID (Grid Manager) 
|===
