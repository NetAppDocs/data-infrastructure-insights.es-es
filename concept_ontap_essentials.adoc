...
El panel de seguridad te da una vista instantánea de tu situación de seguridad actual, mostrando gráficos sobre el cifrado de volúmenes por hardware y software, el estado de la protección contra la manipulación de archivos y los métodos de autenticación de clúster. Los criterios de seguridad se evalúan según las recomendaciones definidas en el link:https://www.netapp.com/pdf.html?item=/media/10674-tr4569.pdf["* Guía de refuerzo de seguridad de NetApp para ONTAP 9 *"].

Selecciona cualquiera de los recuentos de cifrado o antimanipulación de archivos para sumergirte en tu entorno.
