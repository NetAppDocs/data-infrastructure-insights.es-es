...
summary: Proteja sus datos con la detección de amenazas internas de Storage Workload Security, la visibilidad centralizada en entornos híbridos y el aprendizaje automático avanzado para la detección de anomalías y el cumplimiento. 
---
...
[role="lead"]
Data Infrastructure Insights Storage Workload Security (anteriormente Cloud Secure) protege los datos de tu organización con detección avanzada de amenazas internas e inteligencia procesable. Obtén visibilidad y control centralizados sobre todo el acceso a los datos corporativos en entornos de nube híbrida, asegurando que se cumplan los objetivos de seguridad y cumplimiento mediante la supervisión en tiempo real y las capacidades de respuesta automatizada.
