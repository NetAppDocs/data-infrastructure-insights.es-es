...
+
** Instala link:http://ldaptool.sourceforge.net/["Explorador LDAP"] o link:http://jxplorer.org/["Explorador LDAP de Java"] en cualquier equipo con Windows que pueda conectarse al servidor LDAP.
