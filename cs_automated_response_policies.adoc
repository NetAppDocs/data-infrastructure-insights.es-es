...
summary: Configure políticas de respuesta automatizadas para tomar medidas inmediatas durante incidentes de seguridad, incluidas instantáneas, restricción de acceso de usuarios y notificaciones de webhook para amenazas y comportamiento sospechoso. 
---
...
image:ws_add_attack_policy.png["Cuadro de diálogo para agregar una Attack Policy mostrando el menú desplegable de webhook, ancho=300"]
