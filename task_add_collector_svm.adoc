...
. En cualquier momento, un recopilador de datos debe estar en ejecución y otro se mostrará como _Detenido_.
+
El recopilador de datos del SVM "en ejecución" actual se mostrará como _En ejecución_.  El recopilador de datos del SVM "detenido" actual se mostrará como _Detenido_.

. Siempre que se produzca un cambio, el estado del recopilador de datos cambiará de "en ejecución" a "detenido" y viceversa.
