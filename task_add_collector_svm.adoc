...
* Para conocer las mejores prácticas y recomendaciones completas sobre la configuración de Workload Security FPolicy, consultelink:https://kb.netapp.com/on-prem/ontap/da/NAS/NAS-KBs/DII_Storage_Workload_Security__Fpolicy_Best_Practice_and_Recommendations["Artículo de KB sobre las mejores prácticas de FPolicy"^] .
